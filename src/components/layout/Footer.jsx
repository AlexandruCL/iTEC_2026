        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-neutral-500 max-w-xs leading-relaxed">
              Real-time collaborative coding with AI assistance. Code together,
              build faster.
            </p>
          </div>

          <div>
            <h4 className="text-xs uppercase tracking-wider font-semibold text-neutral-400 mb-4 font-display">
              Product
            </h4>
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                href="https://github.com/AlexandruCL/iTEC_2026"
                target="_blank"
